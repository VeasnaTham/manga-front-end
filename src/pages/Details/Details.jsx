...
function Details() {
  ...
  async function fetchBookDetails() {
    try {
      const response = await axios.get(`http://127.0.0.1:8000/manga/mangas/${id}`);
  ...
  async function setUpdateDetails() {
    try {
      const updateResponse = await axios.put(`http://127.0.0.1:8000/manga/mangas/update_manga/${id}?bid=${bid}`);
